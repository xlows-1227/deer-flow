...
def test_upload_files_syncs_non_local_sandbox_and_marks_markdown_file(tmp_path):
    ...
    sandbox.update_file_from_path.assert_any_call("/mnt/user-data/uploads/report.pdf", str(thread_uploads_dir / "report.pdf"))
    sandbox.update_file_from_path.assert_any_call("/mnt/user-data/uploads/report.md", str(thread_uploads_dir / "report.md"))
...
def test_upload_files_acquires_non_local_sandbox_before_writing(tmp_path):
    ...
    sandbox.update_file_from_path.assert_called_once_with("/mnt/user-data/uploads/notes.txt", str(thread_uploads_dir / "notes.txt"))
