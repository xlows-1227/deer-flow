...
class ExternalAuditRow(Base):
    ...
    external_actor_hash: Mapped[str | None] = mapped_column(String(64))
    ...
    __table_args__ = (
        Index("ix_external_audit_user_created", "user_id", "created_at"),
        Index("ix_external_audit_agent_created", "agent_id", "created_at"),
    )
